...
class AgentsController extends Controller
{
    public function index()
    {
        ...
        return view('laravelticket::admin.agent.index', compact('agents'));
    }
    ...
    public function create()
    {
        ...
        return view('laravelticket::admin.agent.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('status', trans('laravelticket::lang.agents-are-added-to-agents', ['names' => $agents_names]));

        return redirect()->action('\Binshops\LaravelTicket\Controllers\AgentsController@index');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        Session::flash('status', trans('laravelticket::lang.agents-joined-categories-ok'));
    ...
    public function destroy($id)
    {
        ...
        Session::flash('status', trans('laravelticket::lang.agents-is-removed-from-team', ['name' => $agent->name]));
    ...
    {
        $agent = Agent::find($id);
        $agent->laravelticket_agent = false;
        $agent->save();
