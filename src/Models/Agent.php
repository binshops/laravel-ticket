...
class Agent extends User
{
    ...
    {
        if ($paginate) {
            return $query->where('laravelticket_agent', '1')->paginate($paginate, ['*'], 'agents_page');
        } else {
            return $query->where('laravelticket_agent', '1');
        }
    }
    ...
    {
        if ($paginate) {
            return $query->where('laravelticket_admin', '1')->paginate($paginate, ['*'], 'admins_page');
        } else {
            return $query->where('laravelticket_admin', '1')->get();
        }
    }
    ...
    {
        if ($paginate) {
            return $query->where('laravelticket_agent', '0')->paginate($paginate, ['*'], 'users_page');
        } else {
            return $query->where('laravelticket_agent', '0')->get();
        }
    }
    ...
    public function scopeAgentsLists($query)
    {
        if (version_compare(app()->version(), '5.2.0', '>=')) {
            return $query->where('laravelticket_agent', '1')->pluck('name', 'id')->toArray();
        } else { // if Laravel 5.1
            return $query->where('laravelticket_agent', '1')->lists('name', 'id')->toArray();
        }
    }
    ...
    public static function isAgent($id = null)
    {
        ...
        if (auth()->check()) {
            if (auth()->user()->laravelticket_agent) {
                return true;
            }
        }
    ...
    {
        return auth()->check() && auth()->user()->laravelticket_admin;
    }
    ...
    {
        return $this->belongsToMany('Binshops\LaravelTicket\Models\Category', 'laravelticket_categories_users', 'user_id', 'category_id');
    }
    ...
    {
        if ($complete) {
            return $this->hasMany('Binshops\LaravelTicket\Models\Ticket', 'agent_id')->whereNotNull('completed_at');
        } else {
            return $this->hasMany('Binshops\LaravelTicket\Models\Ticket', 'agent_id')->whereNull('completed_at');
        }
    }
    ...
    {
        if ($complete) {
            return $this->hasMany('Binshops\LaravelTicket\Models\Ticket', 'user_id')->whereNotNull('completed_at');
        } else {
            return $this->hasMany('Binshops\LaravelTicket\Models\Ticket', 'user_id')->whereNull('completed_at');
        }
    }
    ...
    {
        return $this->hasMany('Binshops\LaravelTicket\Models\Ticket', 'agent_id');
    }
    ...
    {
        return $this->hasMany('Binshops\LaravelTicket\Models\Ticket', 'user_id');
    }
