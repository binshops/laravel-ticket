...
use Binshops\LaravelTicket\Models\Setting as Table;
...
class Setting extends Model
{
     ...
     * @var string
     */
    protected $table = 'laravelticket_settings';
    ...
    public static function grab($slug)
    {
        ...
        $setting = Cache::remember('laravelticket::settings.'.$slug, $time, function () use ($slug, $time) {
            $settings = Cache::remember('laravelticket::settings', $time, function () {
                return Table::all();
            });
