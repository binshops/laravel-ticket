...
ENDHTML
    ...
    , 'include_font_awesome' => <<<'ENDHTML'
			<p>If Font-awesome css is included outside laravelticket, this should be set to <code>0</code></p>
...
ENDHTML
    ...
    , 'bootstrap_version' => <<<'ENDHTML'
			<p>Laravel 5.6+ defaults to CSS library Bootstrap version 4. Here, you can set what version should LaravelTicket use. Allowed values are <code>3</code> and <code>4</code>.
			</p>
ENDHTML
