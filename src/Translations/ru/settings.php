...
return [
    ...
    'main_route'               => '<p><b>LaravelTicket основной route</b>: Базовый URL тикет-системы (например <code>http://&laquo;APP_URL&raquo;/tickets</code>)</p>',
    'admin_route'              => '<p><b>LaravelTicket административный route</b>: URL по которому будет находиться административная панель (например <code>http://&laquo;APP_URL&raquo;/tickets-admin</code>)</p>',
...
HTML
    ...
    'routes' => <<<'HTML'
			...
			<p>
				Пригодится, если необходимо заменить или исключить некоторые компоненты LaravelTicket
			</p>
HTML
