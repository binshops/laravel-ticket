...
@section('page')
    {{ trans('laravelticket::admin.index-title') }}
@stop
    ...
    @if($tickets_count)
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i> {{ trans('laravelticket::admin.index-performance-indicator') }}
                        <div class="pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li>
                                        <a href="{{ action('\Binshops\LaravelTicket\Controllers\DashboardController@index', 2) }}">
                                            {{ trans('laravelticket::admin.index-3-months') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ action('\Binshops\LaravelTicket\Controllers\DashboardController@index', 5) }}">
                                            {{ trans('laravelticket::admin.index-6-months') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ action('\Binshops\LaravelTicket\Controllers\DashboardController@index', 11) }}">
                    ...
                    <div id="information-panel-categories" class="list-group tab-pane fade {{$active_tab == "cat" ? "in active" : ""}}">
                        <a href="#" class="list-group-item disabled">
                            <span>{{ trans('laravelticket::admin.index-category') }}
                                <span class="badge">{{ trans('laravelticket::admin.index-total') }}</span>
                            </span>
