...
@section('page')
    {{ trans('laravelticket::lang.index-title') }}
@stop

@section('content')
    @include('laravelticket::shared.header')
    @include('laravelticket::tickets.index')
@stop

@section('footer')
	<script src="https://cdn.datatables.net/v/bs/dt-{{ Binshops\LaravelTicket\Helpers\Cdn::DataTables }}/r-{{ Binshops\LaravelTicket\Helpers\Cdn::DataTablesResponsive }}/datatables.min.js"></script>
	<script>
	    $('.table').DataTable({
	        processing: false,
	        serverSide: true,
