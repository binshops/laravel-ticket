...
@section('page', trans('laravelticket::admin.index-title'))
...
@section('laravelticket_extra_content')
            ...
            <div class="card bg-light col">
                <div class="card-body align-items-center">
                    ...
                    <div class="col-9 text-right">
                        <h1>{{ $tickets_count }}</h1>
                        <div>{{ trans('laravelticket::admin.index-total-tickets') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-danger col">
                <div class="card-body align-items-center">
                    ...
                    <div class="col-9 text-right">
                        ...
                        <div>{{ trans('laravelticket::admin.index-open-tickets') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-success col">
                <div class="card-body align-items-center">
                    ...
                    <div class="col-9 text-right">
                        ...
                        <span>{{ trans('laravelticket::admin.index-closed-tickets') }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 mt-3">
                <div class="card ">
                    <div class="card-header d-flex justify-content-between align-items-baseline flex-wrap">
                        <div><i class="fas fa-chart-bar fa-fw"></i> {{ trans('laravelticket::admin.index-performance-indicator') }}</div>
                        <div class="btn-group">
                            <button type="button" class="btn btn-secondary btn-sm dropdown-toggle" data-toggle="dropdown">
                                {{ trans('laravelticket::admin.index-periods') }}
                                <span class="caret"></span>
                            </button>
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" href="{{ action('\Binshops\LaravelTicket\Controllers\DashboardController@index', 2) }}">
                                    {{ trans('laravelticket::admin.index-3-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\Binshops\LaravelTicket\Controllers\DashboardController@index', 5) }}">
                                    {{ trans('laravelticket::admin.index-6-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\Binshops\LaravelTicket\Controllers\DashboardController@index', 11) }}">
                                    {{ trans('laravelticket::admin.index-12-months') }}
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-deck mt-3">
                    <div class="card ">
                        <div class="card-header">
                            {{ trans('laravelticket::admin.index-tickets-share-per-category') }}
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            {{ trans('laravelticket::admin.index-tickets-share-per-agent') }}
                        </div>
                        <div class="panel-body">
                ...
                <div class="tab-content">
                    <div id="information-panel-categories" class="list-group tab-pane fade {{$active_tab == "cat" ? "show active" : ""}}">
                        <a href="#" class="list-group-item list-group-item-action disabled">
                            <span>{{ trans('laravelticket::admin.index-category') }}
                                <span class="badge badge-pill badge-secondary">{{ trans('laravelticket::admin.index-total') }}</span>
                            </span>
                    ...
                    <div id="information-panel-agents" class="list-group tab-pane fade {{$active_tab == "agents" ? "show active" : ""}}">
                        <a href="#" class="list-group-item list-group-item-action disabled">
                            <span>{{ trans('laravelticket::admin.index-agent') }}
                                <span class="badge badge-pill badge-secondary">{{ trans('laravelticket::admin.index-total') }}</span>
                            </span>
                            <span class="pull-right text-muted small">
                                <em>
                    ...
                    <div id="information-panel-users" class="list-group tab-pane fade {{$active_tab == "users" ? "show active" : ""}}">
                        <a href="#" class="list-group-item list-group-item-action disabled">
                            <span>{{ trans('laravelticket::admin.index-user') }}
                                <span class="badge badge-pill badge-secondary">{{ trans('laravelticket::admin.index-total') }}</span>
                            </span>
                            <span class="pull-right text-muted small">
                                <em>
    ...
    @else
        <div class="card text-center">
            {{ trans('laravelticket::admin.index-empty-records') }}
        </div>
    @endif
@stop
@section('footer')
