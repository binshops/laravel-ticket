...
<script type="text/javascript">
    ...
    loadCSS({!! '"'.asset('https://cdn.datatables.net/v/bs4/dt-' . Binshops\LaravelTicket\Helpers\Cdn::DataTables . '/r-' . Binshops\LaravelTicket\Helpers\Cdn::DataTablesResponsive . '/datatables.min.css').'"' !!});
    @if($editor_enabled)
