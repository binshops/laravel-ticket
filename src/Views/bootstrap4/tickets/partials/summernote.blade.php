...
@if($codemirror_enabled)
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/{{Binshops\LaravelTicket\Helpers\Cdn::CodeMirror}}/mode/xml/xml.min.js"></script>
@endif

<script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/{{Binshops\LaravelTicket\Helpers\Cdn::Summernote}}/summernote-bs4.min.js"></script>
@if($editor_locale)
