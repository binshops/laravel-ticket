...
Route::group(['middleware' => \Binshops\LaravelTicket\Helpers\LaravelVersion::authMiddleware()], function () use ($main_route, $main_route_path, $admin_route, $admin_route_path) {

    //Route::group(['middleware' => '', function () use ($main_route) {
    //Ticket public route
    Route::get("$main_route_path/complete", 'Binshops\LaravelTicket\Controllers\TicketsController@indexComplete')
            ->name("$main_route-complete");
    Route::get("$main_route_path/data/{id?}", 'Binshops\LaravelTicket\Controllers\TicketsController@data')
            ->name("$main_route.data");

    $field_name = last(explode('/', $main_route_path));
    Route::resource($main_route_path, 'Binshops\LaravelTicket\Controllers\TicketsController', [
            'names' => [
    ...
    Route::resource("$main_route_path-comment", 'Binshops\LaravelTicket\Controllers\CommentsController', [
            'names' => [
    ...
    Route::get("$main_route_path/{id}/complete", 'Binshops\LaravelTicket\Controllers\TicketsController@complete')
            ->name("$main_route.complete");

    //Ticket reopen route for permitted user.
    Route::get("$main_route_path/{id}/reopen", 'Binshops\LaravelTicket\Controllers\TicketsController@reopen')
            ->name("$main_route.reopen");
    //});

    Route::group(['middleware' => 'Binshops\LaravelTicket\Middleware\IsAgentMiddleware'], function () use ($main_route, $main_route_path) {
        ...
        Route::get("$main_route_path/agents/list/{category_id?}/{ticket_id?}", [
            ...
            'uses' => 'Binshops\LaravelTicket\Controllers\TicketsController@agentSelectList',
        ]);
    });

    Route::group(['middleware' => 'Binshops\LaravelTicket\Middleware\IsAdminMiddleware'], function () use ($admin_route, $admin_route_path) {
        ...
        Route::get("$admin_route_path/indicator/{indicator_period?}", [
                ...
                'uses' => 'Binshops\LaravelTicket\Controllers\DashboardController@index',
        ]);
        Route::get($admin_route_path, 'Binshops\LaravelTicket\Controllers\DashboardController@index');

        //Ticket statuses admin routes (ex. http://url/tickets-admin/status)
        Route::resource("$admin_route_path/status", 'Binshops\LaravelTicket\Controllers\StatusesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/priority", 'Binshops\LaravelTicket\Controllers\PrioritiesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/agent", 'Binshops\LaravelTicket\Controllers\AgentsController', [
            'names' => [
        ...
        //Agents management routes (ex. http://url/tickets-admin/agent)
        Route::resource("$admin_route_path/category", 'Binshops\LaravelTicket\Controllers\CategoriesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/configuration", 'Binshops\LaravelTicket\Controllers\ConfigurationsController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/administrator", 'Binshops\LaravelTicket\Controllers\AdministratorsController', [
            'names' => [
        ...
        // Route::get("$admin_route/demo-seeds", 'Binshops\LaravelTicket\Controllers\InstallController@demoDataSeeder');
    });
});
